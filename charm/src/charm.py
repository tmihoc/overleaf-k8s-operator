...
#         }
        ...
        web_api_env.update({"LISTEN_ADDRESS":"0.0.0.0", "ENABLED_SERVICES":"api", "METRICS_APP_NAME":"web-api"})                                                                                                                                                      
        web_env = common_env.copy() 
        web_env.update({"LISTEN_ADDRESS":"127.0.0.1", "ENABLED_SERVICES":"web", "WEB_PORT":"4000"})                       
        pebble_layer = {
